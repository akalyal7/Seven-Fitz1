    ...
    return (
        <footer className="bg-secondary-900 text-white pt-24 pb-12 border-t border-white/5">
            <div className="container-custom">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-20">
                    ...
                    <div>
                        ...
                        <ul className="space-y-5">
                            <li><Link to="/shop?category=Dresses" className="text-secondary-400 hover:text-primary-500 transition-colors text-xs font-bold uppercase tracking-widest">Dresses</Link></li>
                            <li><Link to="/shop?category=Outerwear" className="text-secondary-400 hover:text-primary-500 transition-colors text-xs font-bold uppercase tracking-widest">Outerwear</Link></li>
                            <li><Link to="/shop?category=Bottoms" className="text-secondary-400 hover:text-primary-500 transition-colors text-xs font-bold uppercase tracking-widest">Bottoms</Link></li>
                            <li><Link to="/shop?category=Knitwear" className="text-secondary-400 hover:text-primary-500 transition-colors text-xs font-bold uppercase tracking-widest">Knitwear</Link></li>
                ...
                <div className="border-t border-white/5 pt-12 flex flex-col md:flex-row justify-between items-center text-[10px] font-bold tracking-[0.2em] uppercase text-secondary-500 space-y-6 md:space-y-0">
